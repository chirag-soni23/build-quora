...
// Define the Quora header component
function Quoraheader() {
   // State to manage the modal for adding a question
   const [isModalOpen,setIsModalOpen] = useState(false);

   // State to manage the modal for creating a post
   const [isModalOpen2,setIsModalOpen2] = useState(false);

   // Define an element to close the modal (X icon)
    ...
    <div className="header">
      ...
      >
        ...
        <div className="modal__Field">
          ...
          <div style={{
            ...
            {/* 
              Optional: Input field for including a link that gives context
      ...
      >
        ...
        <div className="modal__button">
          ...
          <button className="add" type="Submit" onClick={() => setIsModalOpen2(false)}>
            Post
          </button>
        </div>
      </Modal>
